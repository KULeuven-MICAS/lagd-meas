module xillybus_block
  ...
  input [31:0] axi_data_r_read_32_2,
  ...
  input axi_ready_w_write_32_2,
  input axi_ready_w_write_8,
  input axi_valid_r_read_32,
  input axi_valid_r_read_32_2,
  ...
  output [31:0] axi_data_w_write_32_2,
  output [3:0] GPIO_LED,
  ...
  wire  user_r_mem_32_rden_w;
  wire  user_r_mem_32_empty_w;
  wire [31:0] user_r_mem_32_data_w;
  wire  user_r_mem_32_eof_w;
  wire  user_r_mem_32_open_w;
  wire  user_w_mem_32_wren_w;
  wire  user_w_mem_32_full_w;
  wire [31:0] user_w_mem_32_data_w;
  wire  user_w_mem_32_open_w;
  wire [15:0] user_mem_32_addr_w;
  wire  user_mem_32_addr_update_w;
  reg user_r_mem_32_rden_d;
  reg user_w_mem_32_wren_d;
  ...
  wire  user_r_read_32_2_rden_w;
  wire  user_r_read_32_2_empty_w;
  wire [31:0] user_r_read_32_2_data_w;
  wire  user_r_read_32_2_eof_w;
  wire  user_r_read_32_2_open_w;
  wire full_r_read_32_2;
  reg to_host_read_32_2_open_pre1;
  reg to_host_read_32_2_open_pre2;
  ...
  wire  user_w_write_32_2_wren_w;
  wire  user_w_write_32_2_full_w;
  wire [31:0] user_w_write_32_2_data_w;
  wire  user_w_write_32_2_open_w;
  wire empty_w_write_32_2;
  reg from_host_write_32_2_open_pre1;
  reg from_host_write_32_2_open_pre2;
  ...
  reg from_host_write_8_open_pre2;
   ...
   // Bogus connections of some user_r_mem_32_* signals to prevent trimming
   // of logic which would result in Vivado failing to implement the design.
   // These assignments have no functional purpose.

   assign user_r_mem_32_eof_w = 1;
   assign user_r_mem_32_empty_w = user_r_mem_32_rden_d || user_r_mem_32_open_w;
   assign user_r_mem_32_data_w = 0;

   always @(posedge bus_clk)
     user_r_mem_32_rden_d <= user_r_mem_32_rden_w;

   // Bogus connections of some user_w_mem_32_* signals to prevent trimming
   // of logic which would result in Vivado failing to implement the design.
   // This assignment has no functional purpose.

   assign user_w_mem_32_full_w = user_w_mem_32_open_w || user_w_mem_32_wren_d;

   always @(posedge bus_clk)
     user_w_mem_32_wren_d <= user_w_mem_32_wren_w;
   ...
   fifo_xillybus_32 r_read_32_2
     (
      .rst(!user_r_read_32_2_open_w),
      .wr_clk(ap_clk),
      .rd_clk(bus_clk),
      .din(axi_data_r_read_32_2),
      .wr_en(axi_ready_r_read_32_2 && axi_valid_r_read_32_2),
      .rd_en(user_r_read_32_2_rden_w),
      .dout(user_r_read_32_2_data_w),
      .full(full_r_read_32_2),
      .empty(user_r_read_32_2_empty_w)
      );

   assign user_r_read_32_2_eof_w = 0;
   assign axi_ready_r_read_32_2 = !full_r_read_32_2;

   always @(posedge ap_clk)
     begin
       to_host_read_32_2_open_pre1 <= user_r_read_32_2_open_w;
       to_host_read_32_2_open_pre2 <= to_host_read_32_2_open_pre1;
       to_host_read_32_2_open <= to_host_read_32_2_open_pre2;
     end
   ...
   fifo_xillybus_fwft_32 fifo_w_write_32_2
     (
      .rst(!user_w_write_32_2_open_w),
      .wr_clk(bus_clk),
      .rd_clk(ap_clk),
      .din(user_w_write_32_2_data_w),
      .wr_en(user_w_write_32_2_wren_w),
      .rd_en(axi_ready_w_write_32_2 && axi_valid_w_write_32_2),
      .dout(axi_data_w_write_32_2),
      .full(user_w_write_32_2_full_w),
      .empty(empty_w_write_32_2)
      );

   assign axi_valid_w_write_32_2 = !empty_w_write_32_2;

   always @(posedge ap_clk)
     begin
       from_host_write_32_2_open_pre1 <= user_w_write_32_2_open_w;
       from_host_write_32_2_open_pre2 <= from_host_write_32_2_open_pre1;
       from_host_write_32_2_open <= from_host_write_32_2_open_pre2;
     end
  ...
  xillybus_core xillybus_core_ins (
    ...
    // FPGA to CPU signals:
    .user_r_mem_32_rden_w(user_r_mem_32_rden_w),
    .user_r_mem_32_empty_w(user_r_mem_32_empty_w),
    .user_r_mem_32_data_w(user_r_mem_32_data_w),
    .user_r_mem_32_eof_w(user_r_mem_32_eof_w),
    .user_r_mem_32_open_w(user_r_mem_32_open_w),

    // CPU to FPGA signals:
    .user_w_mem_32_wren_w(user_w_mem_32_wren_w),
    .user_w_mem_32_full_w(user_w_mem_32_full_w),
    .user_w_mem_32_data_w(user_w_mem_32_data_w),
    .user_w_mem_32_open_w(user_w_mem_32_open_w),

    // Address signals:
    .user_mem_32_addr_w(user_mem_32_addr_w),
    .user_mem_32_addr_update_w(user_mem_32_addr_update_w),
    ...
    // FPGA to CPU signals:
    .user_r_read_32_2_rden_w(user_r_read_32_2_rden_w),
    .user_r_read_32_2_empty_w(user_r_read_32_2_empty_w),
    .user_r_read_32_2_data_w(user_r_read_32_2_data_w),
    .user_r_read_32_2_eof_w(user_r_read_32_2_eof_w),
    .user_r_read_32_2_open_w(user_r_read_32_2_open_w),
    ...
    // CPU to FPGA signals:
    .user_w_write_32_2_wren_w(user_w_write_32_2_wren_w),
    .user_w_write_32_2_full_w(user_w_write_32_2_full_w),
    .user_w_write_32_2_data_w(user_w_write_32_2_data_w),
    .user_w_write_32_2_open_w(user_w_write_32_2_open_w),
