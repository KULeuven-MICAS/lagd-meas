...
set_output_delay -clock [get_clocks clk_chip_sclk] -min -add_delay 5 [get_ports {chip_csb_o}]
set_output_delay -clock [get_clocks clk_chip_sclk] -min -add_delay 5 [get_ports {chip_sd_io[*]}]
set_output_delay -clock [get_clocks clk_chip_sclk] -min -add_delay 5 [get_ports {chip_bootmode_o[*]}]
set_output_delay -clock [get_clocks clk_chip_sclk] -min -add_delay 5 [get_ports chip_rtc_o]
...
set_output_delay -clock [get_clocks clk_chip_sclk] -max -add_delay 5 [get_ports {chip_csb_o}]
set_output_delay -clock [get_clocks clk_chip_sclk] -max -add_delay 5 [get_ports {chip_sd_io[*]}]
set_output_delay -clock [get_clocks clk_chip_sclk] -max -add_delay 5 [get_ports {chip_bootmode_o[*]}]
set_output_delay -clock [get_clocks clk_chip_sclk] -max -add_delay 5 [get_ports chip_rtc_o]