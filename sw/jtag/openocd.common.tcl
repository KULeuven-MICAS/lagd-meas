...
# The file is copied from: cheshire/util/openocd.common.tcl, cheshire repository [commit: 55650af]
# Following changes are made by Jiacong Sun
# - Enable telnet_port and tcl_port (comment out those lines)
